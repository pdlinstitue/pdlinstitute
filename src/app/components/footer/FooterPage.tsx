...
const Footer : React.FC = () => {
  ...
  return (
    <footer className="bg-orange-700 text-white mt-16 p-6 md:p-0">
      <Container>
        <div className="flex flex-col md:flex-row justify-between pt-16 pb-8">
            <FooterList>
              ...
              <Link href="/">
                <Image alt="pdlinstitute" className="shadow-xl rounded-md" src="/images/pdlLogo.jpg" width={120} height={120}/>
              </Link>
            </FooterList>
            <FooterList>
      ...
      <div className=" bg-white text-black p-4 text-center text-sm font-bold">
