...
const Practice: React.FC = () => {
  ...
  useEffect(() => {
    async function fetchPracticeData() {
      try {
        const res = await fetch(`${BASE_API_URL}/api/course-practice`, {
          cache: "no-store",
        });
    ...
    () => [
      ...
      { header: "Language", accessorKey: "prcLang" },
      {
        ...
        cell: ({ row }: { row: any }) => {
          ...
          const currentTimeOnly = currentTime.toLocaleTimeString("en-US", {
            hour12: false,
          });
          ...
          if (
            ...
            currentTimeOnly >= prcStartsAt &&
            currentTimeOnly <= prcEndsAt
          ) {
            return (
        ...
        cell: ({ row }: { row: any }) => (
          <div className="flex items-center gap-3">
            <button
              ...
              onClick={() =>
                router.push(
                  `/account/course-practice/${row.original._id}/view-practice-class`
                )
              }
            ...
            <button
              ...
              onClick={() =>
                router.push(
                  `/account/course-practice/${row.original._id}/edit-practice-class`
                )
              }
            ...
            <button
              ...
              onClick={() =>
                router.push(
                  `/account/course-practice/${row.original._id}/disable-practice-class`
                )
              }
            ...
            <button
              ...
              onClick={() =>
                router.push(
                  `/account/course-practice/${row.original._id}/delete-practice-class`
                )
              }
