...
interface ViewPracticeClassProps {
  prcName:string,
  prcImg:string,
  prcLang:string,
  prcDays:string,
...
const ViewPracticeClass : React.FC<IPrcParams> = ({params}) => {
  ...
  const [data, setData] = useState<ViewPracticeClassProps>({prcName:'', prcLang:'', prcDays:'', prcStartsAt:'', prcEndsAt:'', prcLink:'', prcWhatLink:'',  prcImg:'', usrId:''});
  ...
  return (
    <div className='flex justify-center items-center my-4 '>
      <form className='formStyle w-[500px]'>
        ...
        <div className="mt-4">
            <button type="button" className="btnLeft" onClick={() => router.push("/account/course-practice")}>Back</button>
        </div>
      </form>
    </div>
  )
...
export default ViewPracticeClass;
