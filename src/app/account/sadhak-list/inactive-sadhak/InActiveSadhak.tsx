...
interface InActiveSadhakProps {
    inActiveUserList: InActiveSadhakListProps[];
}

const InActiveSadhak : React.FC <InActiveSadhakProps> = ({inActiveUserList}) => {
