...
interface SdkProfileProps {
    sdkProfileById:SdkProfileItems;
}
...
const SadhakProfile: React.FC<SdkProfileProps> = ({ sdkProfileById }) => {
  ...
  const [sdkData, setSdkData] = useState<SdkProfileItems>(sdkProfileById);
  ...
  //         `${BASE_API_URL}/api/users/${sdkData?._id}/view-sadhak`,
  //         { cache: "no-store" }
  //       );
