...
const EditMyPanCard: React.FC <IDocParams> = ({params}) => {
  ...
  const fetchPanData = async () => {
    try {
        ...
        setPreview(data.docById?.sdkPan);
    } catch (error) {
      ...
      <form className="formStyle w-[450px]" onSubmit={handleSubmit}>
        ...
        <div className="flex flex-col gap-2">
          ...
          <div className="flex gap-1">
            <input type='file' accept="image/*" className='inputBox w-full' name="sdkPan"  onChange={handleFileChange}/>
