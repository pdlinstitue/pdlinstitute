...
const EditMyIdCard: React.FC <IDocParams> = ({params}) => {
      ...
      <form className="formStyle w-[450px]" onSubmit={handleSubmit}>
        ...
        <div className="flex flex-col gap-2">
          ...
          <div className="flex gap-1">
            <input type='file' className='inputBox w-full' name="sdkIdProof" onChange={handleFileChange}/>
        ...
        <div className="flex flex-col gap-2">
          ...
          <input type='text' className='inputBox'name="sdkIdNbr" value={data.sdkIdNbr} onChange={handleChange}/>
        </div>
