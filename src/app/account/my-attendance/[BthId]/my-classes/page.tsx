        ...
        cell: ({ row }: { row: any }) => (
          <div className="flex items-center gap-3 justify-center">
            <button
              ...
              onClick={() =>
                router.push(
                  `/account/my-attendance/${BthId}/my-classes/${row.original._id}/view-attendance`
                )
              }
              className="text-green-600 border-[1.5px] border-green-800 p-1 rounded-full  hover:border-black"
            >
              <FiEye size={12} />
            </button>
          </div>
          ...
          <div>
            <div className="flex mt-4 gap-1">
              ...
              <button
                ...
                onClick={() => {
                  setPageInput((prev) =>
                    Math.min(prev + 1, table.getPageCount())
                  );
                  table.nextPage();
                }}
