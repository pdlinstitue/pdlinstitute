        ...
        cell: ({ row }: { row: any }) => (
          <div className="flex items-center gap-3">
            <button
              ...
              onClick={() =>
                router.push(
                  `/account/course-list/${row.original._id}/view-course`
                )
              }
            ...
            <button
              ...
              onClick={() =>
                router.push(
                  `/account/course-list/${row.original._id}/edit-course`
                )
              }
            ...
            <button
              ...
              onClick={() =>
                router.push(
                  `/account/course-list/${row.original._id}/disable-course`
                )
              }
            ...
            <button
              ...
              onClick={() =>
                router.push(
                  `/account/course-list/${row.original._id}/delete-course`
                )
              }
