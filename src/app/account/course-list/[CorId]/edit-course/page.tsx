...
const EditCourse: React.FC<ICourseParams> = ({params}) => {
    ...
    const [data, setData] = useState<EditCourseProps>({coName:'', coNick:'', coShort:'', coType:'', coAuth:'', coDon:0, coDesc:'', prodType:'Courses', coCat:'', coElg:'', coWhatGrp:'', coTeleGrp:'', durDays:0, durHrs:0, coImg:'', usrId:''})    
            ...
            <div className="flex flex-col gap-2">
                ...
                <div className="flex flex-col gap-2">
                    ...
                    <select name="coElg" value={data.coElg} onChange={handleChange} className='inputBox'>
                        ...
                        <option value="BASIC EDC-1">BASIC EDC-1</option>
                    </select>
                </div>
            </div>
        </div>
