...
const AddNewEvent: React.FC = () => {
  ...
  const [data, setData] = useState<AddNewEventProps>({ eveName: "", eveCatId: "", eveAud: "", eveType: "", eveMode: "", eveDon:0, eveShort: "", eveStartAt: "", eveEndAt: "", eveDesc: "", eveDate: "", eveLink: "", eveLoc: "", eveSpeak: "", evePer: "", eveCont: "", eveImg: "", usrId: ""});
      ...
      <form onSubmit={handleSubmit} className="formStyle w-full">
        ...
        <div className="grid grid-cols-3 gap-1">
            <div className="flex flex-col gap-2">
                ...
                <select className='inputBox' name="eveMode" value={eventMode} onChange={handleEventMode}>
