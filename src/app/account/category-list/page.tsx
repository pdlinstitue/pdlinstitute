        ...
        cell: ({ row }: { row: any }) => (
          <div className="flex items-center gap-3">
            <button
              ...
              onClick={() =>
                router.push(
                  `/account/category-list/${row.original._id}/view-category`
                )
              }
            ...
            <button
              ...
              onClick={() =>
                router.push(
                  `/account/category-list/${row.original._id}/edit-category`
                )
              }
            ...
            <button
              ...
              onClick={() =>
                router.push(
                  `/account/category-list/${row.original._id}/disable-category`
                )
              }
            ...
            <button
              ...
              onClick={() =>
                router.push(
                  `/account/category-list/${row.original._id}/delete-category`
                )
              }
