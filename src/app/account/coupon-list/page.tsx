...
const Couponlist: React.FC = () => {
        ...
        cell: ({ row }: { row: any }) => (
          <div className="flex items-center gap-3">
            <button
              ...
              onClick={() =>
                router.push(
                  `/account/coupon-list/${row.original._id}/view-coupon`
                )
              }
            ...
            <button
              ...
              onClick={() =>
                router.push(
                  `/account/coupon-list/${row.original._id}/edit-coupon`
                )
              }
            ...
            <button
              ...
              onClick={() =>
                router.push(
                  `/account/coupon-list/${row.original._id}/disable-coupon`
                )
              }
            ...
            <button
              ...
              onClick={() =>
                router.push(
                  `/account/coupon-list/${row.original._id}/delete-coupon`
                )
              }
  ...
  useEffect(() => {
    async function fetchCouponData() {
      try {
        const res = await fetch(`${BASE_API_URL}/api/coupons`, {
          cache: "no-store",
        });
