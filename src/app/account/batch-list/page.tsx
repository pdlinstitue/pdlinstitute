...
const BatchList: React.FC = () => {
  ...
  const formatDate = (date: string) => {
    return format(new Date(date), "MMM dd'th', yyyy");
  };
        ...
        cell: ({ row }: { row: any }) => (
          <div className="flex items-center gap-3">
            <button
              ...
              onClick={() =>
                router.push(
                  `/account/batch-list/${row.original._id}/view-batch`
                )
              }
            ...
            <button
              ...
              onClick={() =>
                router.push(
                  `/account/batch-list/${row.original._id}/edit-batch`
                )
              }
            ...
            <button
              ...
              onClick={() =>
                router.push(
                  `/account/batch-list/${row.original._id}/disable-batch`
                )
              }
            ...
            <button
              ...
              onClick={() =>
                router.push(
                  `/account/batch-list/${row.original._id}/delete-batch`
                )
              }
    ...
    async function fetchBatchData() {
      try {
        const res = await fetch(
          `${BASE_API_URL}/api/batches?dur=${selectedDuration}`,
          { cache: "no-store" }
        );
