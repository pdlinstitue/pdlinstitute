    ...
    <div className='flex justify-center items-center print-content'>
      <div className='formStyle w-auto  my-24'>
        <div className='flex flex-col items-center justify-center p-3  bg-gray-100 rounded-lg'>
          <Image src="/images/pdlLogo.jpg" alt="Logo" width={80} height={80} className='rounded-full' />
        ...
        <div className='grid grid-cols-1 md:grid-cols-2 gap-1'>
          ...
          <div className='flex flex-col gap-1 bg-gray-100 rounded-lg p-3'>
            ...
            <p className='text-sm'><span className='pr-2 font-semibold'>ROLE:</span>{myIDCard.sdkRole}</p>
            <p className='text-sm '><span className='pr-2 font-semibold'>SDK ID:</span>{myIDCard.sdkRegNo}</p>
            <p className='text-sm '><span className='pr-2 font-semibold'>DOB:</span>{myIDCard.sdkBthDate}</p>
            <p className='text-sm '><span className='pr-2 font-semibold'>LOCATION:</span>{myIDCard.sdkCity}, {myIDCard.sdkState}</p>
            <p className='text-sm '><span className='pr-2 font-semibold'>COUNTRY:</span>{myIDCard.sdkCountry}</p>
          </div>
        </div>
