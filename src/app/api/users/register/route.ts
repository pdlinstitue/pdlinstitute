...
export async function POST(req: NextRequest) {
  ...
  try {
    ...
    await dbConnect();
    const { sdkFstName, sdkMdlName, sdkLstName, sdkBthDate, sdkGender, sdkMarStts, sdkSpouce, sdkPhone, sdkWhtNbr, sdkEmail,sdkCountry, sdkState, sdkCity, sdkComAdds, sdkParAdds, sdkPwd, sdkConfPwd, sdkImg, sdkRole, createdBy  }: SdkType = await req.json();
    ...
    if(sdkPwd && sdkConfPwd){
       if(sdkPwd !== sdkConfPwd){
        ...
        const newUser = new Users({ sdkFstName, sdkMdlName, sdkLstName, sdkBthDate, sdkGender, sdkMarStts, sdkSpouce, sdkPhone, sdkWhtNbr, sdkEmail, sdkCountry, sdkState, sdkCity, sdkComAdds, sdkParAdds, sdkPwd: hashedPwd, sdkImg, sdkRole, createdBy});
