...
export async function POST(req:NextRequest) {
    try {
        ...
        const uniqueName = (fileName ? fileName.split('/').pop() : `profileImage_${Date.now()}.jpeg`) || `profileImage_${Date.now()}.jpeg`;
        const filePath = join(process.cwd(), "public/profile-images", uniqueName);
